...
class ValidationErrorMessageTest extends AbstractSchemaTest {
    ...
    public function testOneFieldlessErrorJSON() {
        ...
        $this->assertEquals(
            [
                ...
                'code' => 400,
                'errors' => [
                    ['message' => '!error 1', 'status' => 400, 'field' => '', 'code' => 'error 1']
                ]
        ], $json);
    }
    ...
    public function testComplexErrorJSON() {
        ...
        $this->assertEquals(['message' => '!Foo', 'code' => 433, 'errors' => [
            ['message' => '!error 1', 'status' => 400, 'field' => 'Field 1', 'code' => 'error 1'],
            ['message' => '!error 2', 'status' => 400, 'field' => 'Field 1', 'code' => 'error 2'],
            ['message' => '!error 1', 'status' => 400, 'field' => 'Field 2', 'code' => 'error 1'],
            ['message' => '!error 2', 'status' => 400, 'field' => 'Field 2', 'code' => 'error 2'],
            ['message' => '!foo', 'status' => 400, 'field' => 'Field X', 'code' => 'error 1'],
        ]], $json);
    }
